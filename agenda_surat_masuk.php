            ...
            <style type="text/css">
                ...
                @media print{
                    ...
                    .mengetahui {
                        ...
                        font-size: 12px;
                        color: #000; /* Ubah warna tulisan menjadi hitam */
                        margin-bottom: 80px; /* Tambahkan margin bawah untuk jarak spasi */
                    }
                }
            </style>';
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                ...
                echo '
                    ...
                    <div class="tanggal-cetak">Tanggal Cetak: '.date("d-m-Y").'</div>
                    <div class="mengetahui">Mengetahui,<br/><br/><br/><br/>Muhammad Syahrul</div>';
            }
        } else {
